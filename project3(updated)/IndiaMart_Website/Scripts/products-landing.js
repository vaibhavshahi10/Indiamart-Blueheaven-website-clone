...
function display(array,container)
{
    ...
    box.setAttribute("id","boxID-products-landing");
    
    let link=document.createElement("a");
    link.innerText="view more";
    link.setAttribute("id","linkID-products-landing");

    let outsideinnerboxes=document.createElement("div");
    outsideinnerboxes.setAttribute("id","outsideinnerboxesID-products-landing");
    var count=0;
    let imagebox;
    let name;
    let btn;
    array.every((el)=>{
        ...
        innerboxes.setAttribute("id","innerboxesID-products-landing");


        imagebox=document.createElement("div");
        imagebox.setAttribute("id","imageboxID-products-landing");

        let image=document.createElement("img");
        image.src=el.image;
        image.setAttribute("id","imageID-products-landing");

        name=document.createElement("span");
        name.innerText=el.title;
        name.setAttribute("id","nameID-products-landing");

        imagebox.append(image);
        innerboxes.append(imagebox,name);
        outsideinnerboxes.append(innerboxes);
    ...
    btnbox.setAttribute("id","btnboxID-products-landing");
    
    btn=document.createElement("button");
    btn.innerText="View more details"
    btn.setAttribute("id","btnID-products-landing");

    btnbox.append(btn);
    box.append(link,outsideinnerboxes,btnbox);
    ...
    else if( pount===7)
    {
        ...
        link.href="lipcare.html";  
    }
}
let arr1=getarray("makeup");
let container1=document.querySelector("#makeup_div-products-landing");
display(arr1,container1);

let arr2=getarray("lipstick");
let container2=document.querySelector("#lipstick_div-products-landing");
display(arr2,container2);

let arr3=getarray("lipsProducts");
let container3=document.querySelector("#lipsProducts_div-products-landing");
display(arr3,container3);

let arr4=getarray("bleachCream");
let container4=document.querySelector("#bleachCream_div-products-landing");
display(arr4,container4);

let arr5=getarray("scrubs");
let container5=document.querySelector("#scrubs_div-products-landing");
display(arr5,container5);

let arr6=getarray("eyesProducts");
let container6=document.querySelector("#eyesProducts_div-products-landing");
display(arr6,container6);

let arr7=getarray("lipcare");
let container7=document.querySelector("#lipCare_div-products-landing");
display(arr7,container7);

let arr8=getarray("traditionalItems");
let container8=document.querySelector("#traditionalItems_div-products-landing");
display(arr8,container8);

let arr9=getarray("creams");
let container9=document.querySelector("#creams_div-products-landing");
display(arr9,container9);

let arr10=getarray("nailsProducts");
let container10=document.querySelector("#nailsProducts_div-products-landing");
display(arr10,container10);

let arr11=getarray("roseWater");
let container11=document.querySelector("#roseWater_div-products-landing");
display(arr11,container11);

document.querySelector("#makeup_head").addEventListener("click",function(){
    window.location.href="makeup.html";
})
document.querySelector("#lipstick_head").addEventListener("click",function(){
    window.location.href="lipstick.html";
})
document.querySelector("#lipsProducts_head").addEventListener("click",function(){
    window.location.href="lipsProducts.html";
})
document.querySelector("#bleachCream_head").addEventListener("click",function(){
    window.location.href="bleachCream.html";
})
document.querySelector("#scrubs_head").addEventListener("click",function(){
    window.location.href="scrubs.html";
})
document.querySelector("#eyesProducts_head").addEventListener("click",function(){
    window.location.href="eyesProducts.html";
})
document.querySelector("#lipCare_head").addEventListener("click",function(){
    window.location.href="lipcare.html";
})
document.querySelector("#traditionalItems_head").addEventListener("click",function(){
    window.location.href="";
})
document.querySelector("#creams_head").addEventListener("click",function(){
    window.location.href="";
})
document.querySelector("#nailsProducts_head").addEventListener("click",function(){
    window.location.href="";
})
document.querySelector("#roseWater_head").addEventListener("click",function(){
    window.location.href="";
})
